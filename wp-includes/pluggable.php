...
if ( ! function_exists( 'wp_validate_redirect' ) ) :
	...
	function wp_validate_redirect( $location, $fallback_url = '' ) {
		 ...
		 */
		$allowed_hosts = (array) apply_filters( 'allowed_redirect_hosts', array( 'localhost' ), array( isset( $lp['host'] ) ? $lp['host'] : '' ) );

		if ( isset( $lp['host'] ) && ( ! in_array( $lp['host'], $allowed_hosts, true ) && ( strtolower( 'localhost' ) !== $lp['host'] ) ) ) {
