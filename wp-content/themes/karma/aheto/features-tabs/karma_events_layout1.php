...
extract($atts);
//$karma_events_pricings = $this->parse_group($karma_events_pricings);
//
//if ( empty($karma_events_pricings) ) {
//	return '';
//}
 ...
 * Set dependent style
 */
$shortcode_dir = get_template_directory_uri() . '/aheto/features-tabs/';
					...
					<li class="aheto-tabs__list-item <?php echo esc_attr($active); ?>">
						<a href="#" data-pricing-filter=".<?php echo esc_html($filter_heading); ?>"
						   class="aheto-tabs__list-link js-tab-list">
							...
							<?php if ( $item['karma_events_pricings_heading'] ) :

								echo esc_html($item['karma_events_pricings_heading']);
