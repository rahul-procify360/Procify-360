 ...
 * Set dependent style
 */
$shortcode_dir = get_template_directory_uri() . '/aheto/team/';
					...
					<div class="swiper-slide">
							<?php if ( !empty($item['karma_sass_image']) ) :
								...
								<div class="aheto-team__image" <?php echo esc_attr($background_image);?>>
									<?php
									echo Helper::get_social_networks_list('<a class="aheto-team__link" href="%1$s" target="_blank"><i class="ion-social-%2$s"></i></a>', 'karma_sass_', $item);
									?>
								</div>
							<?php endif; ?>
