...
function karma_construction_navigation_layout1($shortcode) {
	...
	karma_add_dependency('list_space', ['karma_construction_layout1'], $shortcode);
	karma_add_dependency(['type_logo', 'text_logo', 'logo'], ['karma_construction_layout1'], $shortcode);
	karma_add_dependency('mob_logo', ['karma_construction_layout1'], $shortcode);
	karma_add_dependency('hovercolor', ['karma_construction_layout1'], $shortcode);
	karma_add_dependency('search', ['karma_construction_layout1'], $shortcode);
	karma_add_dependency('mini_cart', ['karma_construction_layout1'], $shortcode);
