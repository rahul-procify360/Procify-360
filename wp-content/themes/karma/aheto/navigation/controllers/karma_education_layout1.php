...
function karma_education_navigation_layout1($shortcode) {
	...
	karma_add_dependency('list_space', ['karma_education_layout1'], $shortcode);
	karma_add_dependency(['type_logo', 'text_logo', 'logo'], ['karma_education_layout1'], $shortcode);
	karma_add_dependency('mob_logo', ['karma_education_layout1'], $shortcode);
	karma_add_dependency('search', ['karma_education_layout1'], $shortcode);
