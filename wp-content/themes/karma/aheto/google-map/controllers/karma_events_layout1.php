...
function karma_events_google_map_layout1($shortcode) {
	$preview_dir = get_template_directory_uri() . '/aheto/google-map/previews/';
	...
	karma_add_dependency(['height', 'overlay', 'addresses', 'zoom', 'marker'], ['karma_events_layout1'], $shortcode);
