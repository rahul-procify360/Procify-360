...
function karma_construction_custom_post_types_layout1( $shortcode ) {
	...
	karma_add_dependency( ['skin', 'use_heading', 't_heading','add_pagination', 'add_load_more', 'load_more_type', 'load_more_text', 'load_more_loading_text', 'spaces', 'spaces_lg', 'spaces_md', 'spaces_sm', 'spaces_xs' ], [ 'karma_construction_layout1' ], $shortcode );
