...
function karma_construction_custom_post_types_skins( $shortcode ) {
	...
	$shortcode->add_dependecy('karma_construction_use_active_filter_typo', 'template', ['karma_construction_skin-2']);
	$shortcode->add_dependecy('karma_construction_active_filter_typo', 'template', 'karma_construction_skin-2');
...
add_filter( 'aheto_custom_post_types_dynamic_css', 'karma_construction_custom_post_types_skins_dynamic_css', 10, 2 );