...
function karma_education_team_member_layout1($shortcode) {
	$preview_dir = get_template_directory_uri() . '/aheto/team-member/previews/';
	...
	karma_add_dependency(['image', 'name', 'designation', 'image_size', 'networks'], ['karma_education_layout1'], $shortcode);
...
add_filter('aheto_pricing_tables_dynamic_css', 'karma_education_team_member_layout1_dynamic_css', 10, 2);
