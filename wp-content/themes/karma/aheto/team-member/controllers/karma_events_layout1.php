...
function karma_events_team_member_layout1($shortcode) {
	...
	karma_add_dependency(['image', 'name', 'designation', 'image_size', 'networks'], ['karma_events_layout1'], $shortcode);
...
add_filter('aheto_pricing_tables_dynamic_css', 'karma_events_team_member_layout1_dynamic_css', 10, 2);
