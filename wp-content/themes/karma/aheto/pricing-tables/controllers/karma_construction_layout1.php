...
function karma_construction_pricing_tables_layout1($shortcode) {
	...
	karma_add_dependency(['heading', 'link', 'link_style', 'link_border_hover', 'link_border', 'link_bg_hover', 'link_bg', 'link_color_hover', 'link_color', 'features', 'price', 'link_url', 'link_title'], ['karma_construction_layout1'], $shortcode);
