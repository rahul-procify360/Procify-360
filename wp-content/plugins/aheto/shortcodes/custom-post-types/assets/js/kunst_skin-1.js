;(function($, window, document, undefined) {
    ...
    if ( $('.aheto-cpt--kunst__grid').length ) {
        ...
        SlipHover.prototype = {
            ...
            createContainer: function ($element) {
                ...
                let $t = $('.aheto-cpt--kunst__grid').offset().top;
                let $l = $('.aheto-cpt--kunst__grid').offset().left;

                var top = $element.offset().top - $t,
                    left = $element.offset().left - $l,
                ...
                $('.aheto-cpt--kunst__grid').append($overlayContainer);
    ...
    let getTerms;
    let getLength = $('.aheto-cpt--kunst__grid .aheto-cpt__list article').length;

    for (let i = 0; i < getLength; i++) {
        getTerms = $('.aheto-cpt--kunst__grid .aheto-cpt__list').find('.hide > div').eq(i).get(0).outerHTML;

        $('.aheto-cpt--kunst__grid .aheto-cpt-article__inner').eq(i).attr('title', getTerms);
    }

    if ( $('.aheto-cpt--kunst__grid').length ) {
        $('.aheto-cpt--kunst__grid').on('load', function () {
            let styleTitleProps = $('.aheto-cpt--kunst__grid .aheto-cpt__list').find('.hide .aheto-cpt-article__title').css([
                "text-align",
                "color",
                "font-family",
                "font-size",
            ...
            let styleTermsProps = $('.aheto-cpt--kunst__grid .aheto-cpt__list').find('.hide .aheto-cpt-article__terms').css([
                "text-align",
                "color",
                "font-family",
                "font-size",
            ...
            $('.sliphover-container').css('z-index', '50');
            $('.sliphover-container').find('.aheto-cpt-article__title').css(styleTitleProps);
            $('.sliphover-container').find('.aheto-cpt-article__terms').css(styleTermsProps);
        });

        $('.aheto-cpt--kunst__grid .aheto-cpt__list').sliphover({
            target: '.aheto-cpt-article__inner',
