...
$this->add_render_attribute('wrapper', 'class', 'aheto-banner-slider--prego-creative');
...
if ( (empty( $custom_css ) || ( $custom_css == "disabled" ) ) && !Helper::is_Elementor_Live()) {
	wp_enqueue_style('prego-banner-slider-layout3', $shortcode_dir . 'assets/css/prego_layout3.css', null, null);
}
?>
