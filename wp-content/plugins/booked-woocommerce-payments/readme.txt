...
= 1.5.1 =
* *FIX:* The "required" asterisk now shows up correctly for product dropdowns.

= 1.5 =
* *NEW:* The guest booking form now passes the customer name and email to the checkout form. (finally!)
* *FIX:* Shows only the appointment title in the cart/checkout if the option to hide times is set.
* *FIX:* Removed link to product page in cart/checkout.

= 1.4.9 =
* *FIX:* Fixed an issue with the "Auto Cleanup" feature not working in some cases.

= 1.4.8 =
* *FIX:* Polylang support.

= 1.4.7 =
* **NEW:** Added option to choose sending Booked confirmations before or after payment is complete.
* *FIX:* Fixed issues with reminder emails either being sent to unpaid orders, or not being sent at all.
* *FIX:* Fixed an issue where booking agents were not receiving confirmation emails.

= 1.4.6 =
* *FIX:* Fixed an issue with cart thumbnails.
* *FIX:* Fixed an issue with the modal showing an error on some servers.
